...
only; it cannot contact targets or apply changes.
...
the million-observation scale gate, full PQC interoperability, representative
environment validation, and independent validator reports remain future work.
