...
v0.1.2 release. It proves that the release produces a synthetic cryptographic
...
## Immutable v0.1.2 artifact map

Release assets share this immutable prefix:

`https://github.com/577Industries/forge-qbit-qsparx/releases/download/v0.1.2/`

| Artifact | Immutable path |
| --- | --- |
| Protected release | `https://github.com/577Industries/forge-qbit-qsparx/releases/tag/v0.1.2` |
...
| Python wheel | `forge_qbit_qsparx-0.1.2-py3-none-any.whl` |
| Source distribution | `forge_qbit_qsparx-0.1.2.tar.gz` |
