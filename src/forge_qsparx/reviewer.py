...
<body>
  <aside class="boundary-banner" aria-label="Release boundary"><strong>Synthetic · non-authoritative</strong><span>No government network, CUI, active scan, live remediation, FIPS-module validation, or operational performance.</span></aside>
  ...
  <main>
    ...
    <section class="reviewer-orientation" aria-labelledby="orientation-title">
      ...
      <div class="verification-path">
        ...
        <pre tabindex="0" aria-label="Ten-minute verification commands"><code>node --version  # requires v22+; CI/release pin v24
